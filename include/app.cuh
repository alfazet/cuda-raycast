...
{
public:
    constexpr static int DEFAULT_WIN_WIDTH = 1280;
    constexpr static int DEFAULT_WIN_HEIGHT = 720;
    constexpr static int DEFAULT_TEXTURE_WIDTH = DEFAULT_WIN_WIDTH;
    constexpr static int DEFAULT_TEXTURE_HEIGHT = DEFAULT_WIN_HEIGHT;
